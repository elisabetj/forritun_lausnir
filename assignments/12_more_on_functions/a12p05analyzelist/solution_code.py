...
def unique_elements(a_list: List[int]) -> List[int]:
...
def composite_elements(a_list: List[int]) -> List[int]:
...
def calculate_statistics(int_list: List[int]) -> Tuple[int, int, float]:
