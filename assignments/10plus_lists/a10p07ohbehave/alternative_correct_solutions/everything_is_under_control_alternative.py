...
def cross_river(left_side: list, right_side: list, man_is_on_left_side: bool) -> bool:
...
def valid_user_choice(
    left_side: list, right_side: list, man_is_on_left_side: bool, cargo: str
) -> bool:
    return (
        cargo == NOTHING
...
def transport_cargo(
    left_side: list, right_side: list, from_left_to_right: bool, cargo: str
):
