...
while x != -1:
    ...
    current_q = round((previous_q + (x - previous_average) * (x - current_average)),2)
    population_variance = round((current_q / number_count),2)
    standard_deviation = round(math.sqrt(population_variance),2)
