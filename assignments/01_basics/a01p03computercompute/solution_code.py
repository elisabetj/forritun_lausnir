...
# We do not need to worry about printing the correct string of digits exactly,
# since the autograder was set to judge these as numbers, not text,
# and allows for a small error in floating point precision.
print(d)
# See alternative solutions and wrong solutions for more discussion.
